...
public:
	...
	virtual void GetState(OMX_STATETYPE *pState) = 0;
	...
	virtual void UseEGLImage(OMX_BUFFERHEADERTYPE **ppBufferHdr, OMX_U32 nPortIndex, OMX_PTR pAppPrivate, void *eglImage) = 0;
...
typedef std::shared_ptr<IOMXComponent> IOMXComponentSPtr;

class OMXComponent : public IOMXComponent, public MpoDeleter
{
...
public:
	...
	void GetState(OMX_STATETYPE *pState);
	...
	void UseEGLImage(OMX_BUFFERHEADERTYPE **ppBufferHdr, OMX_U32 nPortIndex, OMX_PTR pAppPrivate, void *eglImage);
...
private:
	...
	static IOMXComponentSPtr GetInstance(ILogger *pLogger, ILocker *pLocker, IClock *pClock);

	OMXComponent(ILogger *, ILocker *pLocker, IClock *pClock);
