...
int play(int argc, char* argv[], char* video, time_t date, Timer timer)
{
signal(SIGINT, sig_handler);
  ...
  struct option longopts[] = {
    ...
    { "tile-code",    required_argument,  NULL,          tile_code_opt, },
    { "frame-size",   required_argument,  NULL,          frame_size_opt, },
...
int main(int argc, char *argv[])
{
  ...
  Timer timer;
	play(argc, argv, argv[1], target, timer);
